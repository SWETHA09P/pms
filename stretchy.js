...
function stretchyInit() {
    ...
    var _ = (self.Stretchy = {
        selectors: {
            base:
                'select:not([size]), input:not([type]), input[type="' +
                "text number url email tel"
                    .split(" ")
                    .join('"], input[type="') +
                '"]',
            filter: "*"
        ...
        init: function() {
            _.selectors.filter =
                ...
                (
                    $$("[data-stretchy-filter]").pop() || document.body
                ).getAttribute("data-stretchy-filter") ||
